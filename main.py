...
from app.api.v1 import auth, users, products, categories, cart, order, ai_consultation, payments
...
app.include_router(ai_consultation.router, prefix="/api/v1/ai", tags=["AI Advisor"])
